...
import { traitsType } from "@/store/types";

interface TraitButtonProps {
  type: "add" | "remove";
  name: keyof traitsType;
}
...
export const TraitButton = (props: TraitButtonProps) => {
    ...
    <g id="Capa_1-2" data-name="Capa 1">
      <g id="plus_hitpoints">
        ...
        <rect
          ...
          width="1"
          height="24"
          transform="translate(47 24) rotate(180)"
        />
        <rect
          className={styles.cls3}
          x="11.5"
          ...
          width="1"
          height="24"
          transform="translate(11.5 12.5) rotate(-90)"
        />
        <rect
          className={styles.cls3}
          x="11.5"
          ...
          width="1"
          height="24"
          transform="translate(-11.5 35.5) rotate(-90)"
        />
        <text className={styles.cls2} transform="translate(5.46 18.54)">
          <tspan x="0" y="0">
            {props.type === "add" ? "+" : "-"}
          </tspan>
        </text>
    ...
    return (
      <g id="Capa_1-2" data-name="Capa 1">
        <g id="plus_hitpoints">
          ...
          <rect
            className={styles.cls2Pressed}
            x="11.5"
            y="11.5"
            width="1"
            height="24"
            transform="translate(35.5 11.5) rotate(90)"
          />
          <rect
            className={styles.cls2Pressed}
            x="23"
          ...
          <rect
            className={styles.cls1Pressed}
            x="23"
            width="1"
            height="12"
            transform="translate(47 12) rotate(180)"
          />
          <rect
            className={styles.cls1Pressed}
            x="11.5"
          ...
          />
          <text
            className={styles.cls3Pressed}
            transform="translate(5.46 18.54)"
          >
            <tspan x="0" y="0">
              {props.type === "add" ? "+" : "-"}
            </tspan>
  ...
  return (
    <g onMouseDown={() => mouseDown()} onMouseUp={() => mouseUp()}>
